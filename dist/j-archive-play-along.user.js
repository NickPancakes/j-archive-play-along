  ...
  function ClueCell($$anchor, $$props) {
    ...
    var node = child(button);
    {
      ...
      if_block(node, ($$render) => {
        if (!get(read) && "clueHTML" in $$props.clue) $$render(consequent);
      });
    }
    reset(button);
